...
This chapter defines the structured packet-based communication protocol used for bidirectional data exchange between the embedded firmware and the external Android application.
...
Control packets are transmitted from the Android application to the firmware.
...
Telemetry packets are transmitted from the firmware to the Android application.
